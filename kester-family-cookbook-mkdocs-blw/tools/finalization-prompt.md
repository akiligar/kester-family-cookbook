...
```text
Finalize this meal as a Kester Family Cookbook MkDocs recipe page.
...
- Do not add automation, sync, database, ratings, nutrition, search, CMS, or extra architecture.
- Check whether this is new, a duplicate, or a variation before creating the page.

Output:
1. Duplicate/variation assessment.
2. Recipe slug.
3. Full Markdown file for `docs/recipes/<slug>/index.md`.
4. Updated line for `tools/recipe-index.csv`.
5. Updated nav entry for `mkdocs.yml`.
6. Updated link for `docs/recipes/index.md`.
```
